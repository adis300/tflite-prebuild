...
mkdir -p $BUILD_DIR/pi4/$ARCH_NAME

cp $TF_SRC_DIR/bazel-out/$ARCH_NAME-opt/bin/tensorflow/lite/c/libtensorflowlite_c.so  $BUILD_DIR/pi4/$ARCH_NAME/libtensorflowlite_c.so
